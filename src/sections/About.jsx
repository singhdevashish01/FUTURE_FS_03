          ...
          <div className="about__main">
            <div className="about__visual">
              ...
              <div className="about__experience-card">
                ...
                <p>
                  A relaxed space for everyday moments.
                </p>
              </div>
            </div>
            ...
            <div className="about__content">
              ...
              <p>
                Brew & Bloom is built around a simple idea:
                good coffee and fresh food feel better when
                the environment around them feels equally
                thoughtful.
              </p>

              <p>
                The café concept combines warm interiors,
                approachable service, and carefully presented
                offerings to create a space suitable for quick
                visits, quiet work, and conversations that last
                a little longer.
              </p>
              ...
              <div className="about__quote">
                ...
                <p>
                  A neighbourhood café should feel effortless
                  to visit and easy to return to.
                </p>
              </div>
            </div>
          </div>
