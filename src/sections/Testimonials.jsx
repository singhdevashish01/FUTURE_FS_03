    ...
    >
      <div className="container">
        <Reveal>
          <div className="section-heading">
            ...
            <p className="section-description">
              The website presents sample customer
              perspectives to demonstrate how social
              proof and trust-building content can
              support a local café.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={140}>
          <div className="testimonials__metrics">
            {trustMetrics.map((metric) => (
              <div
                className="testimonials__metric"
                key={metric.label}
              >
        ...
        <p className="testimonials__disclaimer">
          Sample testimonials are included for project
          presentation purposes only and should be
          replaced with verified customer reviews before
          production use.
        </p>
      </div>
    </section>
