          ...
          <div className="why-us__intro">
            <div className="why-us__content">
              ...
              <h2 className="section-title">
                A dependable café experience designed
                around comfort and quality
              </h2>

              <p className="section-description">
                Brew & Bloom combines thoughtful
                service, clear offerings, and a
                welcoming environment to make every
                visit simple and enjoyable.
              </p>
            ...
            <div className="why-us__summary">
              <div className="why-us__summary-main">
                ...
                <p>
                  A straightforward café experience
                  built around freshness, comfort,
                  clarity, and attentive customer
                  service.
                </p>
              </div>
